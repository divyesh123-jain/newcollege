...
const Registeration = () => {
  return (
    ...
    <div className='bg-blue-100 pt-20 pb-16'>
       <h3 className='text-3xl text-[red] mx-7'>Registration</h3>
      ...
      <p className='text-xl mx-7'>The instructions to prepare the aforementioned documents are given below:</p>
    
      <h5 className='text-xl mx-7'>Preparing Camera-Ready paper</h5>
      <ul>
        <li className='text-xl mx-7'>Improve the manuscript according to the reviewers&rsquo; comments</li>
        <li className='text-xl mx-7'>Pages are to be finally formatted according the Manuscript Style Information mentioned in the conference submission guidelines.</li>
        <li className='text-xl mx-7'>Authors should send the source file [Doc/Docx/LaTex] along with final updated PDF file.</li>
      </ul>
     
      <h5 className='text-3xl mx-7 text-[red] pt-4'>Copyright Form</h5>
      <ul>
        <li className='text-xl mx-7'>
        ...
        <li className='text-xl mx-7'>The below attached file allows the user to do an electronic completion of the copyright transferring process.</li>
      ...
      <h4 className='text-3xl mx-7 text-[red]'>Registration Fee</h4>
      <p className='text-xl mx-7'>All the registration fees for UG/PG Students,Research Scholar,Faculty and Industry people are given in this Google Form </p>
<a href="https://forms.gle/QK1GykfyjiQc74r16"><span className=' mx-7 text-xl text-[red]'>ICAETIS Registration Form</span> </a> 
      <p className='text-xl mx-7'>After the successful payment transfer. Take a screenshot of the transaction and save it as a PNG, IMG file.</p>
     
      <h5 className='text-3xl mx-7 text-[red]'>Presentation Guidelines</h5>
      <p className='text-xl mx-7'>
