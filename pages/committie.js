...
Mrs. Deepthi Raj,Assistant Professor,DSCE <br />
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Review Committee</h3>
              <div class="border-b-4 border-indigo-500 ..."></div>
  ...
  Dr. Ganashree T S,Associate Professor,DSCE<br />
   ...
   Mr. Jayanth C,Assistant Professor,DSCE<br />
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Technical Support Committee</h3>
              <div class="border-b-4 border-indigo-500 ..."></div>
              <p class="text-gray-500 dark:text-gray-400 text-xl">
...
Mr. Harsha L<br />
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Program Coordinators</h3>
              <div class="border-b-4 border-indigo-500 ..."></div>
              <p class="text-gray-500 dark:text-gray-400 text-xl">
